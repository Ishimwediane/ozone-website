    ...
    return (
        <section className="section bg-[var(--bg-primary)]">
            <div className="container-custom text-center">
                ...
                <p className="text-xl mb-8 max-w-2xl mx-auto text-[var(--text-secondary)]">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                        href="/portfolio"
                        className="inline-flex items-center justify-center space-x-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-[var(--text-primary)] font-semibold px-10 py-4 rounded-full border-2 border-[var(--border-color)] transition-all duration-300 hover:scale-105"
                    >
